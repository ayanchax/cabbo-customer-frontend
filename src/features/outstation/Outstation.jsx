...
function Outstation() {
  ...
  const findRidesButtonDisabled =!origin || !startDate || !endDate || !hasValidTripDayConstraints || !hasValidHopConstraints || outstationConstraintsLoading || outstationConstraintsError || inProgress
  if (searchResults) {
    return (
      <div
        className={`relative
        ...
        <div className="relative z-10 animate-slide-up duration-300 transition-all">
          ...
          {searchResults?.options && (
            ...
            <div
              ...
              className="scroll-mt-4 px-4 pb-[62vh] sm:pb-0"
            >
